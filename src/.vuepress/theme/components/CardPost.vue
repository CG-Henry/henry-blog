<template>
  <article class="card box-default"
    ...
    <div class="card__box1"
         :class="`card__box1--${cover}`">
      <header>
        <div class="card-category">
          <router-link class="card-category__link"
      ...
      <aside class="row card-info">
        ...
        <div class="column xs-50">
          <router-link class="card-readmore"
                       :to="item.path"
                       :aria-labelledby="`sr-link-post-${item.key}`">
          ...
          <span hidden
                :id="`sr-link-post-${item.key}`"> {{ $t('labelledby_post_card_post') }} {{ item.title }}</span>
        </div>
      </aside>
    </div>

    <div class="card__box2"
