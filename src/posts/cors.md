...
tags: 
  - Javascript
  - 跨域
created_at: 2019-09-25 00:00
updated_at: 2019-09-25 00:33
---
## 1. JSONP跨域
---
...
http-server
```
![cors_01](/blog/images/posts/2019/9/cors_01.png)
...
![cors_02](/blog/images/posts/2019/9/cors_02.png)
...
![cors_03](/blog/images/posts/2019/9/cors_03.png)

打开浏览器访问 http://localhost:8080 就可以看到：

![cors_04](/blog/images/posts/2019/9/cors_04.png)
...
console.log('启动服务，监听 127.0.0.1:3000');
```
通过代码你可以看出，当你访问 http://127.0.0.1:3000 的时候，服务器收到请求，会代你发送请求 https://cnodejs.org/api/v1/topics 最后将获取到的数据发送给浏览器。

同样地开启服务:

![cors_05](/blog/images/posts/2019/9/cors_05.png)

打开浏览器访问 http://localhost:3000/topics，就可以看到

![cors_06](/blog/images/posts/2019/9/cors_06.png)
...
![cors_07](/blog/images/posts/2019/9/cors_07.png)
...
![cors_08](/blog/images/posts/2019/9/cors_08.png)
...
![cors_09](/blog/images/posts/2019/9/cors_09.png)
...
1. [PostMessage_百度百科](https://baike.baidu.com/item/PostMessage/6373972?fr=aladdin)
2. [Window.postMessage()](https://developer.mozilla.org/zh-CN/docs/Web/API/Window/postMessage)
...
这时候只是开启了两个 http 服务器，还需要通过 nginx 做域名映射，将 Example Domain 映射到 localhost:8080，sub.example.com 映射到 localhost:8081 上
...
![cors_10](/blog/images/posts/2019/9/cors_10.png)
...
![cors_11](/blog/images/posts/2019/9/cors_11.png)
